...
function jsPDFInvoiceTemplate(props) {
  ...
  if (
    param.invoice.row4 &&
    (param.invoice.row4.col1 ||
      param.invoice.row4.col2 ||
      param.invoice.row4.col3)
  ) {
    currentHeight += pdfConfig.lineHeight;
    doc.setFontSize(param.invoice.row4.style.fontSize);

    doc.text(docWidth / 1.5, currentHeight, param.invoice.row4.col1, "right");
    doc.text(docWidth - 25, currentHeight, param.invoice.row4.col2, "right");
    doc.text(docWidth - 10, currentHeight, param.invoice.row4.col3, "right");
  }
  //end row4
  ...
  if (
    param.invoice.row5 &&
    (param.invoice.row5.col1 ||
      param.invoice.row5.col2 ||
      param.invoice.row5.col3)
  ) {
    currentHeight += pdfConfig.lineHeight;
    doc.setFontSize(param.invoice.row5.style.fontSize);

    doc.text(docWidth / 1.5, currentHeight, param.invoice.row5.col1, "right");
    doc.text(docWidth - 25, currentHeight, param.invoice.row5.col2, "right");
    doc.text(docWidth - 10, currentHeight, param.invoice.row5.col3, "right");
  }
  //end row5
  ...
  if (
    param.invoice.row6 &&
    (param.invoice.row6.col1 ||
      param.invoice.row6.col2 ||
      param.invoice.row6.col3)
  ) {
    currentHeight += pdfConfig.lineHeight;
    doc.setFontSize(param.invoice.row6.style.fontSize);

    doc.text(docWidth / 1.5, currentHeight, param.invoice.row6.col1, "right");
    doc.text(docWidth - 25, currentHeight, param.invoice.row6.col2, "right");
    doc.text(docWidth - 10, currentHeight, param.invoice.row6.col3, "right");
  }
  //end row6
